...
Expected: "Vincent_Senger@gmail.com"
Received: "Stuart_Lueilwitz@gmail.com"
Timeout:  5000ms

Call log:
  - Expect "toHaveValue" with timeout 5000ms
  - waiting for locator('//input[@name=\'email\']')
    14 × locator resolved to <input id="email" required="" type="email" name="email" value="Stuart_Lueilwitz@gmail.com" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"/>
       - unexpected value "Stuart_Lueilwitz@gmail.com"

```

```yaml
- textbox "Email": Stuart_Lueilwitz@gmail.com
```
