...
- Name: auth.spec.ts >> Ezon - e2e >> fields is not valid
- Location: e2e/specs/auth.spec.ts:43:7
...
Locator: locator('#email+field-error')
...
Call log:
  ...
  - waiting for locator('#email+field-error')
